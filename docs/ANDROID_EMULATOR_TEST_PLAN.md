...
| 1.3.3 | Clear email, type only password "test123", tap Sign In | Same error message appears |
...
| 1.4.2 | Type password: "wrongpassword" | Dots appear in password field |
...
| Step | Action | Expected UI State |
|------|--------|-------------------|
| 1.5.1 | Type "testpass123" in password field | Dots/masked characters shown |
